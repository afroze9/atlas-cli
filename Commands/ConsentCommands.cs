...
public static class ConsentCommands
{
    ...
    {
        var consentCommand = new Command("consent", "Manage consent to atlas-cli terms of use");
        ...
        var grantCommand = new Command("grant", "Accept the terms and grant consent to use atlas-cli");
